...
module Scrapers
  ...
  def self.scrapers
    [BrisbaneScraper.new("Brisbane City Council", "Brisbane", "QLD"),
      ...
      ScraperWikiScraper.new("City of Burnside", "Burnside", "SA"),
      ...
      ScraperWikiScraper.new("City of Marion", "Marion", "SA"),
      ...
      ScraperWikiScraper.new("Coffs Harbour City Council", "Coffs Harbour", "NSW"),
      ScraperWikiScraper.new("Development Assessment Panels", "DAPs WA", "WA"),
      ScraperWikiScraper.new("Gold Coast City Council", "Gold Coast", "QLD"),
      ScraperWikiScraper.new("Gosford City Council", "Gosford", "NSW"),
      ...
      ScraperWikiScraper.new("Mornington Peninsula Shire", "Mornington Peninsula", "VIC"),
      ScraperWikiScraper.new("Mosman Municipal Council", "Mosman", "NSW"),
      ScraperWikiScraper.new("Muswellbrook Shire Council", "Muswellbrook", "NSW"),
      ...
      ScraperWikiScraper.new("NSW Department of Planning Major Project Assessments", "NSW DoP", "NSW"),
      ScraperWikiScraper.new("NSW Joint Regional Planning Panels", "NSW JRPP", "NSW"),
      ScraperWikiScraper.new("NSW Office of Liquor,  Gaming and Racing", "NSW OLGR", "NSW"),
      ScraperWikiScraper.new("City of Onkaparinga", "Onkaparinga", "SA"),
      ScraperWikiScraper.new("Parramatta City Council", "Parramatta", "NSW"),
      ScraperWikiScraper.new("Penrith City Council", "Penrith", "NSW"),
      ScraperWikiScraper.new("City of Perth", "Perth", "WA"),
      ...
      ScraperWikiScraper.new("Rockdale City Council", "Rockdale", "NSW"),
      ...
      ScraperWikiScraper.new("Streamlined Planning through Electronic Applications and Referrals", "SPEAR ,Victoria", "VIC"),
      ...
      ScraperWikiScraper.new("The Hills Shire Council", "The Hills", "NSW"),
      ScraperWikiScraper.new("Toowoomba Regional Council", "Toowoomba", "QLD"),
      ScraperWikiScraper.new("Victorian Commission for Gambling and Liquor Regulation", "VCGLR", "VIC"),
      ScraperWikiScraper.new("Waverley Council", "Waverley", "NSW"),
      ScraperWikiScraper.new("Woollahra Municipal Council", "Woollahra", "NSW"),
      ScraperWikiScraper.new("City of Yarra", "Yarra City", "VIC")
    ]
  end
